...
<body bgcolor="<%= bodyback_c %>">
	...
	<table>
		...
		<tr><td><a href="BookShopServlet?command=book_register_form">상품 등록</a></td></tr>
		<tr><td><a href="BookShopServlet?command=book_kind=all">상품 수정/삭제</a></td></tr>
		<tr><td><a href="BookShopServlet?command=book_list">상품 목록</a></td></tr>
	</table>
