	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("command") == null) { // command 입력값이 null이면 MultipartRequest로 전송된다고 가정함
			try {
				...
				String month = multi.getParameter("publishing_month");
				String day = multi.getParameter("publishing_day");
				...
				System.out.println("book_id 값은 = " + book.getBook_id());
				System.out.println("book_kind 값은 = " + book.getBook_kind());
				System.out.println("book_title 값은 = " + book.getBook_title());
				System.out.println("book_price 값은 = " + book.getBook_price());
				System.out.println("book_count 값은 = " + book.getBook_count());
				System.out.println("author 값은 = " + book.getAuthor());
				System.out.println("publishing_com 값은 = " + book.getPublishing_com());
				System.out.println("publishing_date 값은 = " + book.getPublishing_date());
				System.out.println("book_content 값은 = " + book.getBook_content());
				System.out.println("discount_rate 값은 = " + book.getDiscount_rate());
				System.out.println("book_image 값은 = " + book.getBook_image());
